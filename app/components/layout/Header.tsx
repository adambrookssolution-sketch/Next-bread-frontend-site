    ...
    >
      <Container>
        <nav className="flex items-center justify-between h-16 sm:h-20">
          {/* Logo SVG — switches color based on scroll */}
          ...
          <nav className="flex flex-col items-center justify-center h-full gap-8">
            ...
            {NAV_LINKS.map((link) => (
              <a
                ...
                className="font-[family-name:var(--font-display)] text-2xl text-dark hover:text-primary transition-colors tracking-wider"
              >
                {link.label}
              </a>
            ))}
