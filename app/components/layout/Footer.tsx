...
import type { CmsBrand, CmsLocation } from "@/app/lib/contentful";
...
export default function Footer({ brand, locations }: FooterProps) {
  return (
    <footer className="bg-dark text-white">
      <Container>
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-neutral">
              ...
              <li>
                <a href={`tel:+51${brand.whatsapp}`} className="hover:text-white transition-colors">
                  +51 {brand.whatsapp}
                </a>
              </li>
        ...
        {/* Bottom bar */}
        <div className="border-t border-white/10 py-6 text-center text-xs text-neutral">
