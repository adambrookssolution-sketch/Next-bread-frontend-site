          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="space-y-4">
                ...
                {brand.facebook && (
                  <a
                    ...
                    onClick={() => trackEvent("social_click", { network: "facebook", location: "contact" })}
                    className="flex items-center gap-3 text-neutral hover:text-primary transition-colors group"
                  >
                    <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                ...
                {brand.instagram && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    onClick={() => trackEvent("social_click", { network: "instagram", location: "contact" })}
                    className="flex items-center gap-3 text-neutral hover:text-primary transition-colors group"
                  >
                    <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                      <svg className="w-4 h-4 text-primary" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-[#25D366]/10 p-6 rounded-lg border border-[#25D366]/20">
              ...
              <Button
                ...
                size="md"
                external
                onClick={() => trackEvent("whatsapp_click", { location: "contact_cta" })}
                className="w-full"
              >
